...
// 						 .attr("value", 3).text("Meses"));
    ...
    $('#divTipo').attr('hidden', true);
		...
		elX.append($("<option></option>")
						 .attr("value", 2).text("Filial Responsável"));
// 			 elX.append($("<option></option>")
// 						 .attr("value", 3).text("Transportadora"));
// 			 elX.append($("<option></option>")
// 						 .attr("value", 4).text("Frota Própria"));
	  ...
	  $el.append($("<option selected disabled></option>")
		...
		$el.append($("<option></option>")
               .attr("value", 13).text("Cotação Aprovada / Comercial "));
		$el.append($("<option></option>")
...
// 		  var SelectEixoX = document.getElementById("eixoX");
//       var EIXOX = SelectEixoX.options[SelectEixoX.selectedIndex].value;
...
function CriacaoChartRosca(X,Y) {
 ...
 $( "<center><canvas style='height: 400px;' id='ct-chart' ></canvas><c/center>" ).appendTo( ".ct-chart" );
	...
	console.log(cor);
	 ...
	 chartNumero += '<center>';
		...
		chartNumero += '<div class="card-content" style="border-left:4px solid '+ cor + '">';		
			chartNumero += '	<h5 class="mb-0 mt-0 display-flex justify-content-between">Criação Grafico<i class="material-icons float-right">more_vert</i></h5>';	
  ...
  var cor = $("#cores").val();  
	console.log(cor);
	 ...
	 chartNumero += '<center>';
		chartNumero += '<div class="card animate fadeLeft">';
		chartNumero += '<div class="card-content" style="border-left:4px solid '+ cor + '">';		
			chartNumero += '	<h5 class="mb-0 mt-0 display-flex justify-content-between">Criação Grafico</h5>';	
			chartNumero += 'Todos os Registros';								
			chartNumero += '<div class="current-balance-container exibicaoChart graficonumero">';	
...
function CriacaoChartCduplaTRASPORTADORA(X,Y,P,T){
	
	console.log(X);
	console.log(Y);
	console.log("rdegdfgdfg");


 $('#cores').attr('hidden', true);
 $( ".ct-chart" ).empty();
 $( ".graficonumero" ).empty();
 $( "<input value='7' id='tipo_grafico' type='hidden' ></input>" ).appendTo( ".ct-chart" );	
 $( "<center><canvas style='    height: 256px; !important'   id='ct-chart' heigth='490' ></canvas><c/center>" ).appendTo( ".ct-chart" );
...
var data = {
    ...
    datasets: [
        {
            label: "Entrega por Frota Própria",
					       backgroundColor: [
        '#152C77',
    ],
            fillColor: "rgba(220,220,220,0.5)",
        ...
        {
            label: "Entrega por Transportadora",
									       backgroundColor: [
      '#EEB515',
    ],
            fillColor: "rgba(151,187,205,0.5)",
