...
<head>
  ...
  <meta name="keywords"
    content="Peep, painel de indicadores, indicadores, gestão, metas, dashboard de indicadores, indicadores de desempenho">
...
<body
  ...
  <?php require_once(APPPATH . '/views/fragments/layout/topbar.fragment.php'); ?>

  <?php require_once(APPPATH . '/views/fragments/layout/search-box.fragment.php'); ?>

  <?php
  $Nav = new stdClass;
  $Nav->activeMenuFather = "index";
  $Nav->activeMenuFirst = "index";
  require_once(APPPATH . '/views/fragments/layout/navigation.fragment.php');
  ?>

  <?php require_once(APPPATH . '/views/fragments/layout/pagemain.fragment.php'); ?>

  <?php require_once(APPPATH . '/views/fragments/layout/footer.fragment.php'); ?>
