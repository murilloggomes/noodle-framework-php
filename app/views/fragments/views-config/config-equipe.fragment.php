            ...
            <table id="equipes-table" class="table dt-responsive nowrap w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button style="background: transparent; border: none;" type="button" data-bs-toggle="modal" data-bs-target="#modalEditEquipe<?= $e->get("id"); ?>">		<i class="fa fa-pencil"></i>	</button>
                     <a style="color:black;" href="javascript:void(0)" class="tooltipped remover-dados" data-type="CentroCusto" data-id="<?= $e->get("id"); ?>"data-position="top" data-tooltip="Remover"><i class="fa fa-times" aria-hidden="true"></i></a>
                  </td>
                </tr>
                <?php endforeach; ?>
              </tbody>
