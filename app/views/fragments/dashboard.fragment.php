  ...
  <div class="winston" >
		<div class="card animate fadeLeft">
				...
				<div class="card-content graficos" <?= "style='border-left:4px solid $cor'" ?>>				
					<h5 class="mb-0 mt-0 display-flex justify-content-between"><?= mb_convert_case($ChartI->get("nome"), MB_CASE_TITLE, 'UTF-8') ?> 
						<div class="dropdown">
		...
		<div class="winston">
         ...
         <div class="card animate fadeLeft">
            <div class="card-content graficos">
               <h5 class="mb-0 mt-0 display-flex justify-content-between"><?= mb_convert_case($Chart->get("nome"), MB_CASE_TITLE, 'UTF-8') ?>
								<div class="dropdown">
										<a class="graficoMore" type="button"  data-bs-toggle="dropdown" aria-expanded="false">
											 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                         <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/>
  ...
  <div class="modal-dialog  modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <aside class="skeleton-aside">
				<input class="form-control" required id="nomeChart" name="nomeChart" class="mt-5" value="" style="" type="text" placeholder="Digite o nome do Indicador" value="" required>    
      ...
      <aside class="skeleton-aside-right" style="border-left:solid 1px #cecece; padding: 33px; padding-top:5px;">    
        <div class="row">
          ...
          <div align="center" style="text-align: center;" class="col col-sm-12 col-md-12 col-lg-12 mb-1">
            ...
            <div class="row ml-20">        
              <div class="col col-sm-12 col-md-12 col-lg-12 mb-3">
                  ...
                  <select onchange="indicador()"  required style="width:100%" onchange="ajaxChart()" id="indicador" name="tarefa-principal" class="form-control  select-chart select2" id="tarefa-principal">                     
                 ...
                 <label class="active" for="medida-principal">Tipo de filtro</label>
                  <select required style="width:100%" onchange="ajaxChart()" id="tipoFiltro" name="grupo-principal" class="form-control select-chart select2" >                     
                     <option value="" selected disabled="">Selecione</option>
               ...
               <div class="col col-sm-12 col-md-12 col-lg-12 mb-3">
                 <label class="active" for="medida-principal">Eixo X</label>
                  <select required style="width:100%"  onchange="ajaxChart()" id="eixoX" name="grupo-principal" class="form-control select-chart select2" >                     
                     <option value="" selected disabled="">Selecione</option>
<!-- 										 <option  value="3">Últimos 12 Meses </option>   -->
              ...
              <div class="col col-sm-12 col-md-12 col-lg-12 mb-3">
                  ...
                  <select required  style="width:100%" onchange="ajaxChart()" id="eixoY" name="medida-principal" class="form-control select-chart select2" >                 
                     <option value="" selected disabled="">Selecione</option>
                  </select>                  
              </div>
        </div>
        <div class="row" style="border-bottom:solid 1px #cecece;margin-top:5px">
					<div class="filtros-selecionados" >
						...
						<div id="datainicio" class="col col-sm-12 col-md-12 col-lg-6 mb-3">
							<input  style="width:100%" onchange="ajaxChart()" class="dataComeco form-control form-date" id="dataComeco" name="dataComeco" value="<?=  date('Y-m-d', strtotime('-1 month')) ?>" type="date">Inicio</input>                
						</div>						
						<div  id="datafim" class="col col-sm-12 col-md-12 col-lg-6 mb-3">
							<input  style="width:100%" onchange="ajaxChart()" class="dataFinal form-control form-date" id="dataFinal" name="dataFinal" value="<?= date('Y-m-d') ?>"type="date">Fim</input>                
					...
					<div id="usuarioFiltro" style="border-bottom:solid 1px border-color:#cecece;" >
						 <div class="col col-sm-12 col-md-12 col-lg-12 mb-3">	 <a onclick="fecharUser()" style="color:red; float:right;font-size:18px;">X </a>
						<select  style="width:100%" onchange="ajaxChart(1)"  name="omitir" class="omitir select2 form-control " required id="omitir">
						 ...
						 <div class="col col-sm-12 col-md-12 col-lg-12 mb-3">
                          <select placeholder="Seleciones os Usuarios"  style="width:100%" onchange="ajaxChart()"   id="usuariosSelecionado" class="form-control select2 usuariosSelecionados"  name="usuariosSelecionado"  multiple>
                ...
                <label id="add-filtros" class="add-filtros" style="position:relative; ">              
                	<span onclick="addFiltro()" id="text-filtros">+ Adicionar Filtros</span>
							 ...
							 <div class="selectFiltro"  style="display:none;"> 
							  ...
							  <select style="width:100%" name="selecExc" onchange="ajaxChart(1)" id="select-filtros" class="select2 form-control select-chart" data-id="0" style="display:none">
