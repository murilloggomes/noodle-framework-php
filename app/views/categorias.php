...
<html lang="pt-BR">
    <head>
        <meta charset="utf-8" />
        <title>Categorias | Teste PHP</title>
    ...
    <body class="loading" data-layout-color="light" data-leftbar-theme="default" data-layout-mode="largura_tema" data-rightbar-onstart="true">
        ...
        <div class="wrapper">
            ...
            <div class="content-page">     
						 ...
						 <?php require(APPPATH.'/views/fragments/categoria.fragment.php'); ?>
             <?php require(APPPATH.'/views/fragments/modals/modal-categorias.fragment.php'); ?>
        ...
        <script src="<?= APPURL . "/assets/js/custom/modal-categorias.js"?>"></script>
    </body>
</html>
