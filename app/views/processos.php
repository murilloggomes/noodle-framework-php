...
<!DOCTYPE html>
    ...
    <head>
        ...
        <link href="<?= APPURL . "/app-assets/css/custom/custom.task.css"?>" rel="stylesheet" type="text/css"/>        
        ...
        <div class="wrapper">
          ...
          <?php require(APPPATH.'/views/fragments/siteconfig/modal.fragment.php'); ?>
            ...
            <!-- ============================================================== -->            
            <?php require(APPPATH.'/views/fragments/processos.fragment.php'); ?>
        ...
        <!-- third party js ends -->
        <!-- dragula js-->
        <script src="<?= APPURL . "/assets/js/vendor/dragula.min.js"?>"></script>
        <!-- demo js -->
        <script src="<?= APPURL . "/assets/js/ui/component.dragula.js"?>"></script>
        <script src="<?= APPURL . "/assets/js/custom/custom-processo.js"?>"></script>  
