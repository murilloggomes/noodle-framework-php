<?php 
/**
 * Aplicativo que será rodado todas as funções para iniciar o sistema
 */
class App
{
    protected $router;
    ...
    /**
     * Get App::$routes
     * @return:: pega infomacoes da rota de volta 
     */
    ...
    /**
     * Geolocalização baseado na sessão do usuário
     *      * @return stdClass 
     */
    ...
    /**
     * Chegando se logado e atribuindo uma variavel a sessão
     */
    ...
    /**
     * Verifica qual tema externo está ativo no momento
     * @return void 
     */
    ...
    /**
     * Define a lingua padrão através do plugin i18n
     */
    ...
    /**
     * Analiza as rotas e encaminha para os controllers corretos
     * @return App
     */
    ...
    /**
     * Mapa das rotas internas [apenas para assuntos internos - um middleware ou api do laravel]
     * internal use only.
     */
